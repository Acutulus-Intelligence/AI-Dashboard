...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260605200228_MakeSubscriptionLimitsNullable")]
    partial class MakeSubscriptionLimitsNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.CompanySubscription", b =>
                {
                    b.HasOne("Domain.Models.Company", "Company")
                        .WithOne()
                        .HasForeignKey("Domain.Models.CompanySubscription", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Models.UserSubscription", b =>
                {
                    ...
                    b.HasOne("Domain.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Domain.Models.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
