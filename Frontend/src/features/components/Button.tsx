...
const variants = {
  ...
  outline:
    'border border-on-background text-on-background hover:bg-surface-container focus-visible:outline-brand',
  surface:
    'bg-surface text-on-background hover:bg-surface-container-low focus-visible:outline-surface',
  ghost: 'text-primary hover:bg-surface-container-low focus-visible:outline-brand',
};
